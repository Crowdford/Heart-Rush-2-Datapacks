...
execute unless data storage simplify:main char unless data storage simplify:main temp[0] run data modify storage simplify:io numbers set from storage simplify:main in
