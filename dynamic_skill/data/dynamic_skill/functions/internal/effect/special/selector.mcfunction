...
execute if data storage dynamic_skill:main trigger{spsel:1} if score temp3 dynamic_skill matches 1 run data modify storage dynamic_skill:main trigger_data_translations[0] set value '{"translate":"dynskill.triggers.location1.that"}'
...
execute if data storage dynamic_skill:main trigger{spsel:1} unless score temp3 dynamic_skill matches 1 unless score temp3 dynamic_skill matches 3 run data modify storage dynamic_skill:main trigger_data_translations[10] set value '{"translate":"dynskill.triggers.identity4.that"}'
...
execute if data storage dynamic_skill:main trigger{spsel:1} if data storage dynamic_skill:main {temp:'{"translate":"dynskill.triggers.location1.player"}'} run data modify storage dynamic_skill:main trigger_data_translations[0] set value '{"translate":"dynskill.triggers.location1.player_alt"}'

# save that we already did a special:selector
data modify storage dynamic_skill:main trigger.spsel set value 1
