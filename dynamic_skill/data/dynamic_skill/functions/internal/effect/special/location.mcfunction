...
execute if score int dynamic_skill matches 1 run data modify block 0 1 0 Text1 set value '[{"storage":"dynamic_skill:main","nbt":"spaces","interpret":true}," ",{"italic":true,"translate":"dynskill.effects.location.left.single","with":[{"score":{"name":"int","objective":"dynamic_skill"}}]}]'
execute if score int dynamic_skill matches 2.. run data modify block 0 1 0 Text1 set value '[{"storage":"dynamic_skill:main","nbt":"spaces","interpret":true}," ",{"italic":true,"translate":"dynskill.effects.location.left.multiple","with":[{"score":{"name":"int","objective":"dynamic_skill"}}]}]'
execute if score int dynamic_skill matches -1 run data modify block 0 1 0 Text1 set value '[{"storage":"dynamic_skill:main","nbt":"spaces","interpret":true}," ",{"italic":true,"translate":"dynskill.effects.location.right.single","with":[{"score":{"name":"temp","objective":"dynamic_skill"}}]}]'
execute if score int dynamic_skill matches ..-2 run data modify block 0 1 0 Text1 set value '[{"storage":"dynamic_skill:main","nbt":"spaces","interpret":true}," ",{"italic":true,"translate":"dynskill.effects.location.right.multiple","with":[{"score":{"name":"temp","objective":"dynamic_skill"}}]}]'
...
execute if score int dynamic_skill matches 1 run data modify block 0 1 0 Text1 set value '[{"storage":"dynamic_skill:main","nbt":"spaces","interpret":true}," ",{"italic":true,"translate":"dynskill.effects.location.forward.single","with":[{"score":{"name":"int","objective":"dynamic_skill"}}]}]'
execute if score int dynamic_skill matches 2.. run data modify block 0 1 0 Text1 set value '[{"storage":"dynamic_skill:main","nbt":"spaces","interpret":true}," ",{"italic":true,"translate":"dynskill.effects.location.forward.multiple","with":[{"score":{"name":"int","objective":"dynamic_skill"}}]}]'
execute if score int dynamic_skill matches -1 run data modify block 0 1 0 Text1 set value '[{"storage":"dynamic_skill:main","nbt":"spaces","interpret":true}," ",{"italic":true,"translate":"dynskill.effects.location.backward.single","with":[{"score":{"name":"temp","objective":"dynamic_skill"}}]}]'
execute if score int dynamic_skill matches ..-2 run data modify block 0 1 0 Text1 set value '[{"storage":"dynamic_skill:main","nbt":"spaces","interpret":true}," ",{"italic":true,"translate":"dynskill.effects.location.backward.multiple","with":[{"score":{"name":"temp","objective":"dynamic_skill"}}]}]'
execute unless score int dynamic_skill matches 0 run data modify storage dynamic_skill:main stack[-4].value append from block 0 1 0 Text1
