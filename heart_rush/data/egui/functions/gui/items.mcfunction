...
execute as @s[scores={tsEGUI_guiVal=7}] if score @s gold matches 50.. run give @s carrot_on_a_stick{CustomModelData:4,display:{Name:'[{"translate":"equipment.item.speed_crystal","color":"gray","italic":false}]',Lore:['{"color":"gray","italic":false,"translate":"equipment.item.speed_crystal.description.1","with":[{"keybind":"key.use"}]}','{"color":"gray","italic":false,"translate":"equipment.item.speed_crystal.description.2"}']},CanDestroy:["#main:breakable"],HideFlags:63}
