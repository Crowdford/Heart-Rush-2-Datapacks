...
# armor 
execute if data entity @s ActiveEffects[{Id:14b}] run function main:game/equipment/armor_invisible
execute unless data entity @s ActiveEffects[{Id:14b}] run function main:game/equipment/armor_visible
