...
## Usage: Run the function at the location where it should create a fake lightning e.g. /execute positioned ^ ^ ^25 run function main:util/lightning
...
# Setup
execute unless block ~ ~ ~ command_block unless block ~ ~ ~ chain_command_block align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~-1 ~ air if block ~ ~ ~ air if block ~ ~1 ~ air run playsound minecraft:entity.lightning_bolt.thunder master @s ~ ~ ~ 1 0.7
...
execute unless block ~ ~ ~ command_block unless block ~ ~ ~ chain_command_block align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~-1 ~ air if block ~ ~ ~ spawner if block ~ ~1 ~ air run setblock ~ ~-1 ~ minecraft:repeating_command_block[facing=up]{Command:"function main:util/lightning",auto:1b}
execute unless block ~ ~ ~ command_block unless block ~ ~ ~ chain_command_block align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~-1 ~ repeating_command_block if block ~ ~ ~ spawner if block ~ ~1 ~ air run summon falling_block ~ ~0.5 ~ {Motion:[0.0,0.2,0.0],BlockState:{Name:"minecraft:command_block",Properties:{facing:"up"}},TileEntityData:{Command:"function main:util/lightning",auto:1b},Time:1}
