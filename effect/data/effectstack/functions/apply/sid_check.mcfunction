...
execute if score #success effectstack matches 0 unless data storage effectstack:main effect run data modify storage effectstack:main temp2 append from storage effectstack:main player[0]
